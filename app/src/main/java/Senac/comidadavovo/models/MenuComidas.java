...
public class MenuComidas implements Parcelable {
    ...
    private void addFrangoXadrez() {
        Comida frangoXadrez = new Comida("Frango Xadrez", Categoria.CB, new Imagem(R.drawable.frangoxadrez, R.mipmap.ic_frangoxadrez));
    ...
    private void addStronoff() {
        Comida strogonoff = new Comida("Strogonoff de carne", Categoria.CV, new Imagem(R.drawable.strogonoffdecarne, R.mipmap.ic_strogonoffdecarne));
    ...
    private void addSopaAlhoComBatata() {
        Comida sopa = new Comida("Sopa de alho-poró com batata", Categoria.CD, new Imagem(R.drawable.sopadebatatacomalhoporo, R.mipmap.ic_sopadebatatacomalhoporo));
    ...
    public List<Comida> getComidas(String nomeCategoria) {
        List<Comida> lista = new ArrayList<>();

        for (Comida comida : this.comidas)
            if (comida.getCategoria() == Categoria.fromString(nomeCategoria.toLowerCase()))
                lista.add(comida);
